...
export interface ViewportSettings {
  ...
  /** Performance mode - disables heavy effects for smooth 60fps */
  performanceMode: boolean
  /** Device pixel ratio override (1 = native, 0.5 = half resolution) */
  dprOverride: number
}
...
export const DEFAULT_VIEWPORT_SETTINGS: ViewportSettings = {
  ...
  // Performance settings
  performanceMode: false, // Disabled by default - toggle for smooth 60fps
  dprOverride: 1, // 1 = native resolution, 0.75 = 75% for better performance
}
