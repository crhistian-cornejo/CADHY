...
export {
  regenerateAllDrawingViews,
  triggerDrawingRegeneration,
  useDrawingSync,
} from "./use-drawing-sync"
export {
...
export { shapeIdMap, useCAD } from "./use-kernel"
export { useCADOperationHotkeys } from "./use-operator-hotkeys"
export { type OperationDialogState, useCADOperations } from "./use-operators"
