 ...
 * AI Provider Icons
 *
 * SVG icons for AI model providers (Anthropic/Claude, OpenAI, Google/Gemini, xAI/Grok)
 * These are NOT hugeicons - they are custom brand logos.
 */
...
/**
 * OpenAI icon
 * Uses currentColor so it adapts to the text color
 */
...
/**
 * Gemini icon (Google)
 * Colorful gradient sparkle logo
 */
...
/**
 * Grok icon (xAI)
 * X logo - uses currentColor
 */
export function GrokIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg data-slot="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        fill="currentColor"
...
/**
 * Get provider icon component by provider name
 */
export function getProviderIcon(provider: string): React.FC<SVGProps<SVGSVGElement>> {
  switch (provider) {
    case "anthropic":
      return ClaudeIcon
    case "openai":
