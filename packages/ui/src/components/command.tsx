...
import { InputGroup, InputGroupAddon } from "@cadhy/ui/components/input-group"
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="bg-transparent dark:bg-transparent border-input/30 h-8! rounded-lg! shadow-none! *:data-[slot=input-group-addon]:pl-2!">
        <CommandPrimitive.Input
          data-slot="input-group-control"
          className={cn(
            "w-full text-sm bg-transparent outline-none disabled:cursor-not-allowed disabled:opacity-50",
            className
          )}
          {...props}
        />
